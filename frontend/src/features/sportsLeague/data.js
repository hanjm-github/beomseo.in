...
export const SPORTS_LEAGUE_STORAGE_VERSION = '2026.03.14';
...
export const SPORTS_LEAGUE_SEED = {
  category: {
    ...
    gradeLabel: '3학년',
    sportLabel: '남자 축구',
    statusNote: '학생회 이상 권한으로 실시간 문자중계를 입력할 수 있습니다.',
  ...
  teams: [
    ...
    { id: 'team-3-1-3-3', name: '3-1·3-3', shortName: '3-1·3-3', group: 'B', tone: 'groupB' },
    { id: 'team-3-2-3-4', name: '3-2·3-4', shortName: '3-2·3-4', group: 'B', tone: 'groupB' },
    { id: 'team-3-5-3-7', name: '3-5·3-7', shortName: '3-5·3-7', group: 'B', tone: 'groupB' },
    { id: 'placeholder-a-1', name: 'A조 1위', shortName: 'A조 1위', group: 'K', tone: 'knockout' },
    { id: 'placeholder-a-2', name: 'A조 2위', shortName: 'A조 2위', group: 'K', tone: 'knockout' },
    { id: 'placeholder-b-1', name: 'B조 1위', shortName: 'B조 1위', group: 'K', tone: 'knockout' },
    { id: 'placeholder-b-2', name: 'B조 2위', shortName: 'B조 2위', group: 'K', tone: 'knockout' },
    {
