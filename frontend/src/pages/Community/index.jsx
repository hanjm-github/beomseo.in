/**
 * @file src/pages/Community/index.jsx
...
import {
  LOST_FOUND_LEGACY_BASE_PATH,
  LOST_FOUND_NOTICE_BASE_PATH,
} from '../Notices/LostFound/paths';
...
const StudyWithBeomseoPage = lazy(() => import('./StudyWithBeomseo/StudyWithBeomseoPage'));
...
export default function CommunityRouter() {
  return (
    <Routes>
      ...
      <Route path="lost-found/*" element={<LegacyLostFoundRedirect />} />
