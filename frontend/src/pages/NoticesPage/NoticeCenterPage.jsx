/**
 * @file src/pages/NoticesPage/NoticeCenterPage.jsx
 * @description Existing school/council notice board shell and nested routes.
 * Responsibilities:
 * - Preserve the current school and student council notice flows.
 * - Expose list/detail/compose routes for the legacy notice experience.
 * Key dependencies:
 * - react
 * - react-router-dom
 * - lucide-react
 ...
 * Role in app flow:
 * - Owns the existing notice center UX below `/notices`.
 */
...
/**
 * NoticeCenterPage module entry point.
 */
    ...
    <div className="page-shell">
      <div className="page-header">
        <div>
          ...
          <h1>학교 & 학생회 공지</h1>
          <p className="lede">상단 고정, 중요/시험 필터, 빠른 알림까지 한 곳에서 확인하세요.</p>
        </div>
