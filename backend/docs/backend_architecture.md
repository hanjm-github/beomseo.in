...
| `sports_league` | `SportsLeagueCategory`, `SportsLeagueMatch`, `SportsLeagueEvent`, `SportsLeagueStandingOverride` | `sports_league` | 공통 write limit |
...
13. `services/sports_league_realtime.py`
